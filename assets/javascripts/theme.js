									...
									'<div id="formBloqueo">',
										...
										'<div class="form-group mb-lg">',
											'<div class="input-group input-group-icon">',
												'<input id="tPassword" name="tPassword" type="password" class="form-control input-lg" placeholder="Password" />',
											...
											'</div>',
										'</div>',
										'<div id="divRespuestaBloqueo" class="form-group mb-lg" style="display:none;">',
										'</div>',
										'<div class="row">',
											'<div class="col-xs-6">',
											...
											'<div class="col-xs-6 text-right">',
												'<p class="mt-xs mb-none">',
													'<a href="#" onclick="cambiarusuario();">Cambiar usuario</a>',
												'</p>',
											'</div>',
										'</div>',
									'</div>',
